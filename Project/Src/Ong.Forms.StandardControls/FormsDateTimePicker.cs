...
namespace Ong.Friendly.FormsStandardControls
{
    ...
    public class FormsDateTimePicker : FormsControlBase
    {
        ...
        /// Please use FormsDateTimePicker(AppVar windowObject).
        /// </summary>
        ...
        /// <summary>
        /// 現在非推奨です。
        /// FormsDateTimePicker(AppVar windowObject)を使用してください。
        /// </summary>
        /// <param name="app">アプリケーション操作クラス。</param>
        /// <param name="appVar">アプリケーション内変数。</param>
#endif
        [Obsolete("Please use FormsDateTimePicker(AppVar windowObject).", false)]
        ...
        /// <param name="appVar">アプリケーション内変数。</param>
#endif
        public FormsDateTimePicker(AppVar appVar)
            : base(appVar) { }
