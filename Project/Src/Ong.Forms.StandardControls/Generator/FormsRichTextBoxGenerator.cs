...
namespace Ong.Friendly.FormsStandardControls.Generator
{
    ...
    /// コード生成
    /// </summary>
    public class FormsRichTextBoxGenerator : IDisposable
    {
        string _name;
        List<string> _code;
        ...
        public FormsRichTextBoxGenerator(IntPtr handle, string name, List<string> code)
        {
            _name = name;
            _code = code;
            _control = (RichTextBox)Control.FromHandle(handle);
