...
namespace Ong.Friendly.FormsStandardControls
{
    ...
    /// </summary>
#endif
    [ControlDriver(TypeFullName = "System.Windows.Forms.TextBox")]
    public class FormsTextBox : FormsControlBase
    {
        ...
        {
            App[typeof(FormsTextBox), "EmulateChangeTextInTarget"](AppVar, text);
        }
        ...
        {
            App[typeof(FormsTextBox), "EmulateChangeTextInTarget", async](AppVar, text);
        }
