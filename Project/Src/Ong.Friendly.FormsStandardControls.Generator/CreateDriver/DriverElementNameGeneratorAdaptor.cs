...
namespace Ong.Friendly.FormsStandardControls.Generator.CreateDriver
{
    internal class DriverElementNameGeneratorAdaptor
    {
        ...
        public string MakeDriverPropName(object control, string secondCandidate, IList<string> names)
        {
        ...
        private static string ToUniqueName(string nameSrc, IList<string> names)
        {
            var name = nameSrc;
            for (int i = 0;; i++)
            {
